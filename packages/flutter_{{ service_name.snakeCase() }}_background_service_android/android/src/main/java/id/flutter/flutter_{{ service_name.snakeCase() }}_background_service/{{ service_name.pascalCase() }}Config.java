...
public class {{ service_name.pascalCase() }}Config {
    final SharedPreferences pref;

    public {{ service_name.pascalCase() }}Config(Context context) {
        this.pref = context.getSharedPreferences("id.flutter.background_{{ service_name.snakeCase() }}_service", Context.MODE_PRIVATE);
    }
