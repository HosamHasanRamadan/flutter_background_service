library flutter_{{ service_name.snakeCase() }}_background_service_android;
...
Future<void> entrypoint(List<String> args) async {
  ...
  final service = {{ service_name.pascalCase() }}AndroidServiceInstance._();
...
class Flutter{{ service_name.pascalCase() }}BackgroundServiceAndroid extends Flutter{{ service_name.pascalCase() }}BackgroundServicePlatform {
  ...
  static void registerWith() {
    Flutter{{ service_name.pascalCase() }}BackgroundServicePlatform.instance =
        Flutter{{ service_name.pascalCase() }}BackgroundServiceAndroid();
  }

  Flutter{{ service_name.pascalCase() }}BackgroundServiceAndroid._();
  static final Flutter{{ service_name.pascalCase() }}BackgroundServiceAndroid _instance =
      Flutter{{ service_name.pascalCase() }}BackgroundServiceAndroid._();

  factory Flutter{{ service_name.pascalCase() }}BackgroundServiceAndroid() {
    if (!_isMainIsolate) {
      throw Exception(
  ...
  final MethodChannel _channel = MethodChannel(
    'id.flutter/{{ service_name.snakeCase() }}_background_service/android/method',
    JSONMethodCodec(),
  );

  final EventChannel _eventChannel = EventChannel(
    'id.flutter/{{ service_name.snakeCase() }}_background_service/android/event',
    JSONMethodCodec(),
  );
...
class {{ service_name.pascalCase() }}AndroidServiceInstance extends {{ service_name.pascalCase() }}ServiceInstance {
  static const MethodChannel _channel = const MethodChannel(
    'id.flutter/{{ service_name.snakeCase() }}_background_service_android_bg',
    JSONMethodCodec(),
  );

  {{ service_name.pascalCase() }}AndroidServiceInstance._() {
    _channel.setMethodCallHandler(_handleMethodCall);
  }
