library flutter_{{ service_name.snakeCase() }}_background_service_ios;
...
Future<void> foregroundEntrypoint(List<String> args) async {
  ...
  final service = {{ service_name.pascalCase() }}IOSServiceInstance._();
...
Future<void> backgroundEntrypoint(List<String> args) async {
  ...
  final callbackHandle = CallbackHandle.fromRawHandle(handle);
  final onStart = PluginUtilities.getCallbackFromHandle(callbackHandle)
      as FutureOr<bool> Function({{ service_name.pascalCase() }}ServiceInstance instance)?;
  if (onStart != null) {
...
class Flutter{{ service_name.pascalCase() }}BackgroundServiceIOS extends Flutter{{ service_name.pascalCase() }}BackgroundServicePlatform {
  /// Registers this class as the default instance of [FlutterBackgroundServicePlatform].
  static void registerWith() {
    Flutter{{ service_name.pascalCase() }}BackgroundServicePlatform.instance = Flutter{{ service_name.pascalCase() }}BackgroundServiceIOS();
  }

  static const MethodChannel _channel = const MethodChannel(
    'id.flutter/{{ service_name.snakeCase() }}_background_service_ios',
    JSONMethodCodec(),
  );
...
class {{ service_name.pascalCase() }}IOSServiceInstance extends {{ service_name.pascalCase() }}ServiceInstance {
  static const MethodChannel _channel = const MethodChannel(
    'id.flutter/background_service_ios_bg',
    JSONMethodCodec(),
  );

  {{ service_name.pascalCase() }}IOSServiceInstance._() {
